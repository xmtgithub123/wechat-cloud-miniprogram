...
var SHOW_SCREENS = 4;
var MAX_SHOW_SCREENS = 5; // 5和3刚好合适？
var DEFAULT_SHOW_SCREENS = SHOW_SCREENS;
var DEFAULT_MAX_SHOW_SCREENS = MAX_SHOW_SCREENS;
var RECT_SIZE = 200;
var systemInfo = wx.getSystemInfoSync();
var DEBUG = false;
var BOUNDARY_INTERVAL = 400; // 到达边界多少距离的时候, 直接改为边界位置
var THROTTLE_DISTANCE = 2000; // 超过这个的滚动距离必须要抛弃掉
var SETDATA_INTERVAL_BOUNDARY = 300; // 大于300ms则减少MAX_SHOW_SCREEN的值
var SETDATA_INTERVAL_BOUNDARY_1 = 500;
...
Component({
  ...
  methods: {
    ...
    _recycleInnerBatchDataChanged: function _recycleInnerBatchDataChanged() {
      var _this3 = this;
    ...
    _scrollTopChanged: function _scrollTopChanged(newVal, oldVal) {
      ...
      if (!this._isReady) {
        ...
        this._scrollTopTimerId = setTimeout(function () {
          _this4._scrollTopChanged(newVal, oldVal);
        }, 10);
        return newVal;
      }
      this._isInitScrollTop = true;
      ...
      if (this.data.scrollWithAnimation) {
        ...
        // 首次的值需要延后一点执行才能生效
        setTimeout(function () {
          _this4._isScrollTopChanged = true;
          _this4.setData({
            innerScrollTop: newVal
          });
        }, 10);
    ...
    _scrollToIndexChanged: function _scrollToIndexChanged(newVal, oldVal) {
      ...
      if (!this._isReady) {
        ...
        this._scrollToIndexTimerId = setTimeout(function () {
          _this5._scrollToIndexChanged(newVal, oldVal);
        }, 10);
        return newVal;
      }
      this._isInitScrollToIndex = true;
      ...
      if (this.data.scrollWithAnimation) {
        ...
        setTimeout(function () {
          _this5._isScrollToIndexChanged = true;
          _this5.setData({
            innerScrollTop: calScrollTop
          });
        }, 10);
