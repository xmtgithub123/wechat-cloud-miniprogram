...
function RecycleContext(_ref) {
  ...
  if (this.useInPage) {
    ...
    this.page.onPageScroll = function (e) {
      ...
      _this.oldPageScroll.apply(_this.page, [e]);
    };
    this.oldReachBottom = this.page.onReachBottom;
    this.page.onReachBottom = function (e) {
      if (_this.comp) {
        _this.comp.triggerEvent('scrolltolower', {});
      }
      _this.oldReachBottom.apply(_this.page, [e]);
    };
    this.oldPullDownRefresh = this.page.onPullDownRefresh;
    this.page.onPullDownRefresh = function (e) {
      if (_this.comp) {
        _this.comp.triggerEvent('scrolltoupper', {});
      }
      _this.oldPullDownRefresh.apply(_this.page, [e]);
    };
  }
}
